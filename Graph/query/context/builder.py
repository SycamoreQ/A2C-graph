...
class GraphContextBuilder(ABC):
    """Base class for graph related query searches : includes query subgraph searching 
    and gnn or other deep learning based context building
    """
    ...
    def build_context(
        ...
        **kwargs,
        ...
        """Build the context for the graph search mode."""